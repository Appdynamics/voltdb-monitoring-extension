...
public class ProcedureProfileStats extends Stats {

    private static final String METRIC_PATH = "Custom Metrics|VoltDB|Stats|Procedure Profile";

    public ProcedureProfileStats(ProcedureExecutor procedureExecutor, Mode mode) {
    ...
    public Map<String, Number> fetch() throws TaskExecutionException {
        ...
        return getProcedureExecutor().executeProcedure(PROCEDURE_STATS, "PROCEDUREPROFILE", responseProcessor);
    }
}