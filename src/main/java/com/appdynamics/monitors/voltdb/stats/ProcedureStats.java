...
public class ProcedureStats extends Stats {

    private static final String METRIC_PATH = "Custom Metrics|VoltDB|Stats|Procedure";

    public ProcedureStats(ProcedureExecutor procedureExecutor, Mode mode) {
    ...
    public Map<String, Number> fetch() throws TaskExecutionException {
        ...
        return getProcedureExecutor().executeProcedure(PROCEDURE_STATS, "PROCEDURE", responseProcessor);
    }
}