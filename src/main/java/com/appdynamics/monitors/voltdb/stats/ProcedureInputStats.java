...
public class ProcedureInputStats extends Stats {

    private static final String METRIC_PATH = "Custom Metrics|VoltDB|Stats|Procedure Input";

    public ProcedureInputStats(ProcedureExecutor procedureExecutor, Mode mode) {
    ...
    public Map<String, Number> fetch() throws TaskExecutionException {
        ...
        return getProcedureExecutor().executeProcedure(PROCEDURE_STATS, "PROCEDUREINPUT", responseProcessor);
    }
}
