...
public class PartitionCountStats extends Stats {

    private static final String METRIC_PATH = "Custom Metrics|VoltDB|Stats|Partition Count";

    public PartitionCountStats(ProcedureExecutor procedureExecutor, Mode mode) {
    ...
    public Map<String, Number> fetch() throws TaskExecutionException {
        ...
        return getProcedureExecutor().executeProcedure(PROCEDURE_STATS, "PARTITIONCOUNT", responseProcessor);
    }
}