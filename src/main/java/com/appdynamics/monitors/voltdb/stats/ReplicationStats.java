...
public class ReplicationStats extends Stats {

    private static final String METRIC_PATH = "Custom Metrics|VoltDB|Stats|Replication";

    public ReplicationStats(ProcedureExecutor procedureExecutor, Mode mode) {
    ...
    public Map<String, Number> fetch() throws TaskExecutionException {
        ...
        return getProcedureExecutor().executeProcedure(PROCEDURE_STATS, "DR", responseProcessor);
    }
}